...
//            zeile = java.net.URLDecoder.decode(zeile,"UTF-8");
            ...
            if (zeile.startsWith("GET /?exit=Server+beenden HTTP/1.1")) {
                ...
                contentLines = "<p> SERVER wurde beendet!</p>";
                contentLines += "<p> </p>";
                contentLines += "<p> Vielen dank für Ihren Besuch und ein frohes Fest! :-)</p>";
...
//                            System.out.println(name);
                ...
                if (telFalse) {
                    ...
                    if (stack.size() >= 1) {
                        ...
                        contentLines += "<p>No Results found...</p>";
                        ...
                        contentLines += "<p>Wrong Input - is empty...</p>";
